...
public class Assignment28_JotForm {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("first_9")).sendKeys("Anjan");
		driver.findElement(By.id("last_9")).sendKeys("Roy");
		driver.findElement(By.id("input_10")).sendKeys("9830721932");
