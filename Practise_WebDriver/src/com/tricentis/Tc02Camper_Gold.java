...
public class Tc02Camper_Gold {
	...
	public static void main(String[] args) {
		...
		//Select Price Option and checking for correct value.
				...
				String expPrice="1,937.00", expclaim ="Submit", expClaimDis ="2", expCover = "Limited", actPrice, actClaim, actClaimDis, actCover;
				...
				actClaimDis = driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[3]/td[3]")).getText();
