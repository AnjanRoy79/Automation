...
public class Tc04Camper_Ultimate {
	...
	public static void main(String[] args) {
		...
		new Select(driver.findElement(By.id("make"))).selectByVisibleText("Volkswagen");
		driver.findElement(By.id("engineperformance")).sendKeys("2000");
		driver.findElement(By.id("dateofmanufacture")).sendKeys("03/01/2020");
		new Select(driver.findElement(By.id("numberofseats"))).selectByVisibleText("8");
		WebElement radiob = driver.findElement(By.xpath("//*[@id=\"insurance-form\"]/div/section[1]/div[5]/p/label[1]/span"));
		...
		WebElement radiob1 = driver.findElement(By.xpath("//*[@id=\"insurance-form\"]/div/section[2]/div[4]/p/label[1]/span"));
		...
		WebElement hobbies = driver.findElement(By.xpath("//*[@id=\"insurance-form\"]/div/section[2]/div[10]/p/label[4]/span"));
		...
		WebElement radiob2 = driver.findElement(By.xpath("//*[@id=\"insurance-form\"]/div/section[3]/div[4]/p/label[2]/span"));
		...
		//Select Price Option and checking for correct value.
				...
				String expPrice="7,241.00", expclaim ="Submit", expClaimDis ="10", expCover = "Unlimited", actPrice, actClaim, actClaimDis, actCover;
				...
				actClaimDis = driver.findElement(By.xpath("//*[@id=\"priceTable\"]/tbody/tr[3]/td[5]")).getText();
